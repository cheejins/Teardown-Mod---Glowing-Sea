...
do
    ...
    function DirLookAt(eye, target) return VecNormalize(VecSub(eye, target)) end

    -- Angle between two vectors.
    function VecAngle(a,b) return math.deg(math.acos(myDot({a[1], a[2], a[3]}, {b[1], b[2], b[3]}) / (myMag(c) * myMag(d)))) end
